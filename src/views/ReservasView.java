...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblValorSimbolo.setBounds(104, 332, 17, 25);
		...
		txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				// ser calculado
				CalculaValorDiaria calculo = new CalculaValorDiaria(txtDataE.getDate(), txtDataS.getDate());
				if (calculo.getValorDiaria() > 0) {
					txtValor.setText(Double.toString(calculo.getValorDiaria()));
				}
			}
		});
		...
		txtValor.setBounds(131, 328, 106, 33);
		...
		txtFormaPagamento.setModel(new DefaultComboBoxModel(
		...
		btnProximo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtDataE.getDate() != null && ReservasView.txtDataS.getDate() != null) {
					Reserva reserva = new Reserva(txtDataE.getDate(), txtDataS.getDate(),
							Double.parseDouble(txtValor.getText()), txtFormaPagamento.getSelectedIndex());
					// Grava a reserva

					ReservaController reservaController = new ReservaController();
					reservaController.salvar(reserva);

					Integer numeroReserva = reserva.getId();
					// Segue em frente
					RegistroHospede registro = new RegistroHospede();
					registro.setReserva(numeroReserva);
