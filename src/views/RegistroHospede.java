...
public class RegistroHospede extends JFrame {
	...
	public static JDateChooser txtDataN;
	public static JComboBox<Format> txtNacionalidade;
	...
	public void setReserva(int reserva) {
		txtNreserva.setText(Integer.toString(reserva));
	}
	...
	public RegistroHospede() {
		...
		txtSobrenome.setBounds(560, 206, 285, 33);
		...
		labelSalvar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (RegistroHospede.txtNome != null && RegistroHospede.txtSobrenome != null
						&& RegistroHospede.txtDataN != null && RegistroHospede.txtNacionalidade != null
						&& RegistroHospede.txtTelefone != null && RegistroHospede.txtNreserva != null) {
...
//					// Grava o hospede
					...
					sucesso.setVisible(true);
						...
						JOptionPane.showMessageDialog(null, "Ocorreu um erro ao salvar os dados, favor conferir!");
